...
\cvcomputer{Packaging}{deb, rpm, ebuild}{Deployment}{Puppet, Salt, Ansible, Kickstart, Preseed, Terraform, Boto}
\cvcomputer{Network}{Keepalived, OpenVPN, DHCPd, VLANs}{Cloud Provider}{AWS, Azure}

\subsection{Services}
\cvcomputer{Web Server}{Apache, Lighttpd, Nginx, Tomcat}{Directory}{389 Directory, OpenLDAP, Samba4}
\cvcomputer{Database}{MySQL, PosgreSQL, Redis}{Other}{Bind, Ntpd, Cups, Bacula}
...
\cvcomputer{Language}{Shell/Bash, Python, Perl, C, GoLang, Ocaml}{SCM}{Git, Subversion, Mercurial}
\cvcomputer{Framework}{CherryPy, Flask, Twisted}{Specification}{Swagger/OpenAPI}
