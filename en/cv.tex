...
\subsection{System}
\cvcomputer{OS}{Debian/Ubuntu, RedHat EL/CentOS, Gentoo, FreeBSD}{Virtualization}{ESXi, VirtualBox, Vagrant, KVM, LXD, OpenVZ}
\cvcomputer{Packaging}{deb, rpm, ebuild}{Deployment}{Puppet, Ansible, Kickstart, Preseed, Terraform, Boto}
\cvcomputer{Network}{Keepalived, OpenVPN, DHCPd, VLANs}{Cloud Providers}{AWS, Azure}

\subsection{Services}
\cvcomputer{Web Server}{Apache, Lighttpd, Nginx, Tomcat}{Directory}{389 Directory, OpenLDAP, Samba4}
\cvcomputer{Database}{MySQL, PosgreSQL, Redis, DynamoDB, RDS}{Other}{Bind, Ntpd, Cups}
\cvcomputer{Monitoring}{Nagios, NRPE, Logstash, Snmpd, OpenTSDB, Grafana, CollectD}{Security}{Syslog-ng, Rsyslog, OpenSSH, sssd, IPTables, PF, stunnel}
...
\cvcomputer{Documentation}{Vim, reStructuredText, Markdown, \LaTeX, OpenOffice}{Tools}{Jira, Confluence, Github, Travis-ci, Jenkins, Slack}
