...
\cvcomputer{Base de données}{MySQL, PosgreSQL, Redis, DynamoDB, RDS}{Autres services}{Bind, Ntpd, Cups, Bacula}
...
\cvcomputer{Langages}{Shell/Bash, Python, C, Perl, Golang, Ocaml}{Gestionnaires de révisions}{Git, Subversion, Mercurial}
\cvcomputer{Framework}{CherryPy, Flask, Twisted}{Spécification}{Swagger/OpenAPI}
...
\cvcomputer{Documentation}{reStructuredText, Markdown, \LaTeX, LibreOffice}{Outils}{Jira, Confluence, Github, Vim, Travis-ci, Jenkins, Slack}
