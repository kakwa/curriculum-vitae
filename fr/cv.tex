...
\subsection{Système}
\cvcomputer{OS}{Debian/Ubuntu, RedHat EL/CentOS, Gentoo, FreeBSD}{Virtualisation/Containérisation}{ESXi, VirtualBox, Vagrant, KVM, LXD, OpenVZ}
...
\cvcomputer{Supervision}{Nagios, NRPE, Logstash, Snmpd, OpenTSDB, Grafana}{Sécurité}{Syslog-ng, Rsyslog, OpenSSH, Sssd, IPTables, PF}
\cvcomputer{Network FS}{Samba, NFS}{Queueing}{Kafka}

\subsection{Programmation}
\cvcomputer{Langages}{Shell/Bash, Python, Perl, C, Ocaml}{Gestionnaires de révisions}{Git, Subversion, Mercurial}
